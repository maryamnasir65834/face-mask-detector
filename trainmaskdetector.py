...
#Initialising initial learning rate, number of epochs to train for and batch size
INIT_LR= 1e-4
EPOCHS= 20
BS=32
...
#Grabbing the list of images in the dataset then initialising the list of data and class images
...
#Showing formatted classification report
