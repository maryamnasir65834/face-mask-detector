...
#initialise the initial learning rate, number of epochs to train for and batch size
INIT_LR= 1e-4
EPOCHS= 20
BS=32

DIRECTORY=r"C:\Users\DELL\Desktop\face-mask-detector\data"
CATEGORIES= ["with_mask","without_mask"]

#grab the list of images in our dataset directory then initialise the list of data and class images
...
#for each image in the testing set, we need to find the index of the label with corresponding largest predicated probability
